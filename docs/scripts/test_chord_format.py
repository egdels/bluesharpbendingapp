...
# -*- coding: utf-8 -*-
"""
Test script to verify that chord names in the format "C4-E4-G4" are correctly processed.
...
def test_get_label_from_path():
    """Test that get_label_from_path correctly extracts chord names in the format "C4-E4-G4"."""
    # Create a mock file path with a chord name in the format "C4-E4-G4"
    file_path = "/path/to/chord_C4-E4-G4_1.wav"
    ...
    assert label == "C4-E4-G4", f"Expected 'C4-E4-G4', got '{label}'"

    print("get_label_from_path test passed!")

def test_process_labels():
    """Test that process_labels correctly processes chord names in the format "C4-E4-G4"."""
    # Create a list of labels including a chord name in the format "C4-E4-G4"
    labels = ["C4-E4-G4", "Cmaj", "D4-F#4-A4", "G7"]
    ...
    expected_labels = [0, 0, 2, 7]  # C=0, C=0, D=2, G=7
...
def main():
    """Run the tests."""
    print("Testing chord name processing...")
